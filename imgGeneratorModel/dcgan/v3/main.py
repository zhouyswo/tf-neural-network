...
def main(_):
    ...
    with tf.device("/gpu:0"):
        ...
        real_images = tf.placeholder(tf.float32, [None, FLAGS.output_size, FLAGS.output_size, FLAGS.c_dim],
                                     name='real_images')
    ...
    def iterate_minibatches(batch_size, shuffle=True):
        ...
        for start_idx in range(0, num_files - batch_size + 1, batch_size):
            ...
            yield np.array(
                [get_image(file, FLAGS.image_size, is_crop=FLAGS.is_crop, resize_w=FLAGS.output_size, is_grayscale=0)
    ...
    for epoch in range(FLAGS.epoch):
        ...
        for batch_images in iterate_minibatches(FLAGS.batch_size):
            ...
            if np.mod(iter_counter, FLAGS.sample_step) == 0:
                ...
                tl.visualize.save_images(img, [num_tiles, num_tiles],
                                         './{}/train_{:02d}_{:04d}.png'.format(FLAGS.sample_dir, epoch, steps))
