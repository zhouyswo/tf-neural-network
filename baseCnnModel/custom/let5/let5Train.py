...
from baseCnnModel.custom.let5.let5  import LetNet5
...
data_dir ='/opt/workplace/testDatas/data/MNIST/'# 'mnist_data'
ckpt_dir = 'ckpt/'
    ...
    with tf.Session(config=config ) as sess:
        ...
        for i in range(FLAGS.epoch):
            ...
            if i % 10 == 0 or FLAGS.restore:
                ...
                print('iter:' + str(i),
                      sess.run(accuracy, feed_dict={x: test_image_batch, y_: test_label_batch, keep_prob: 1.0}))
